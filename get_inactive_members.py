...
r = requests.get(f"https://api.clashroyale.com/v1/clans/{clan_tag}",
                 headers={"Accept": "application/json", "authorization": token}, params={"limit": 20})
data = r.json()
current_date = datetime.now()


# This function will irritate thorough the .json data returned by the API
...
def get_inactive_members_details(clan_data, days_threshold=4):
    ...
    today = datetime.now()
    inactive_players = []
    # Start to irritate thorough the data and declare variables
